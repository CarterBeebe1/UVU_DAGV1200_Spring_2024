...
//Name: Table.ma
//Last modified: Wed, Jan 31, 2024 04:31:36 AM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "AEBD615A-42D0-0428-3A3C-46BE431256AF";
createNode transform -s -n "persp";
	rename -uid "28A8301C-4EDE-8B91-CC76-8385FC811E37";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.9985477940331267 3.6280100906470549 5.7138953990684191 ;
	setAttr ".r" -type "double3" -14.400000000000285 -673.19999999998583 1.1615543524756655e-15 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D8FCFA62-4D80-F359-0AEC-1081B503CC0D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "75FF4011-4DA8-73C2-5632-188E50CFAB75";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "53491C30-414E-BA6C-E1E8-4AAABCE5863A";
createNode displayLayerManager -n "layerManager";
	rename -uid "BF98FCD0-4749-6819-4E77-3A9B0DD65CBA";
createNode displayLayer -n "defaultLayer";
	rename -uid "CFACB130-4580-2F6D-BB2B-E8BE5DE271BB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "95ED5A3F-4DF5-106A-9BFE-62A2CD85DF77";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "490B2E91-4AF5-0DCA-5BE2-0486021BA980";
